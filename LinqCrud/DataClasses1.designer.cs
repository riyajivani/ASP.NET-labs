...
namespace LinqCrud
{
    ...
    partial void OnDesgChanging(string value);
    ...
    partial void OnSalaryChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Desg", DbType="VarChar(50)")]
		public string Desg
		{
			get
			{
			...
			set
			{
				if ((this._Desg != value))
				{
					this.OnDesgChanging(value);
					this.SendPropertyChanging();
					this._Desg = value;
					this.SendPropertyChanged("Desg");
					this.OnDesgChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Dept", DbType="VarChar(5)")]
		public string Dept
		{
			get
			{
