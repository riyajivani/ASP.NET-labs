...
<body style="height: 557px">
    <form id="form1" runat="server">
        ...
        <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" style="z-index: 1; left: 556px; top: 512px; position: absolute; height: 51px; width: 140px" Text="Submit" />
        ...
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="#CC0066" style="z-index: 1; left: 17px; top: 610px; position: absolute; height: 44px; width: 1137px" />
